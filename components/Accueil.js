    ...
    >
      <div className="md:w-1/2 w-full flex flex-col md:pl-40 max-[767px]:pl-0 max-[767px]:items-center md:pt-15 pt-0  ">
        ...
        <p className="w-full text-white md:text-xl my-5  max-[767px]:p-10 max-[767px]:py-0 max-[767px]:text-justify">
          Étudiant en ingénierie en génie logiciel, je suis particulièrement
          passionné par l'entrepreneuriat et le développement logiciel. De plus,
          je suis enthousiaste à l'idée de participer à des projets dans le
          domaine du développement. Je suis prêt à m'investir dans des missions
          pour contribuer au développement d'une solution et acquérir des
          compétences au sein d'une équipe dynamique.{" "}
        </p>
